...
export const TAB_LABELS: Record<TabType, string> = {
  ...
  update: 'Updates',
  'prompt-library': 'Prompt Library & Rules',
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'prompt-library': 'Manage AI prompts and customize system rules',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'prompt-library', visible: true, window: 'user' as const, order: 4 },
  ...
  { id: 'prompt-library', visible: true, window: 'developer' as const, order: 4 },
